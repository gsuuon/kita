...
/// This section copypasted from https://gist.github.com/mbuhot/c224f15e0266adf5ba8ca4e882f88a75
open System
...
module Serializer =
    ...
    jsonOptions.Converters.Add <| OptionValueConverter()
    jsonOptions.Converters.Add <| OptionConverter()
    jsonOptions.Converters.Add <| MapValueConverter()
    jsonOptions.Converters.Add <| MapConverter()
    jsonOptions.Converters.Add <| ListValueConverter()
    jsonOptions.Converters.Add <| ListConverter()
    ...
    let json =
        { new Serializer<string> with
            ...
            member _.Deserialize x =
                JsonSerializer.Deserialize<'T> (x , jsonOptions)
        }
